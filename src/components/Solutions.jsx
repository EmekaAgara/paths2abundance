        ...
        <div class="max-w-6xl px-12 mx-auto text-center">
            <div class="space-y-12 md:text-center">
                <div class="max-w-3xl mb-20 space-y-5 sm:mx-auto sm:space-y-4">
                    <h2 class="relative text-4xl font-extrabold tracking-tight sm:text-5xl">Latest Solutions</h2>
                    <p class="text-xl text-gray-500">Explore and donate to your preffered Solutions.</p>
                </div>
            </div>
                ...
                <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                    ...
                    <div class="flex justify-center">
                        <div class="rounded-lg shadow-lg bg-white max-w-sm">
                            ...
                            <div class="p-6">
                            <h5 class="text-gray-900 text-xl font-medium mb-2">Farming Solution</h5>
